...
<div class="bg-stars flex h-screen flex-col items-center justify-center text-cosmic-sparkle">
	...
	<nav class="mt-8 flex flex-wrap justify-center gap-8 font-cinzel">
